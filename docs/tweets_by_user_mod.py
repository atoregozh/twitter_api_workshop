...
class TWEET(Base):
    __tablename__ = 'result' # This is table name.
...
class ACCOUNT(Base):
    __tablename__ = 'accounts' # this is the table name for a 
...
def get_data(kid): #refine search here
    try:        
...
class Scrape:
    def __init__(self):    
        engine = sqlalchemy.create_engine("sqlite:////Users/toregozhinaaizhan/projects/twitter_api_workshop/docs/example.db", echo=False)  # different DB name here
